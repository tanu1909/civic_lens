...
const ReportCard = ({ report, onDelete }) => {
    ...
    return (
        ...
        <div className='group bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full overflow-hidden'>
            ...
            <div className='h-48 overflow-hidden relative bg-gray-100 dark:bg-slate-800'>
                ...
                {/* FIXED: Cleaned up Duplicate Props on Delete Button */}
                {report.status === 'Pending' && onDelete && (
                    <button 
                        onClick={(e) => {
                            e.stopPropagation();
                ...
                <div className='mt-auto pt-4 border-t border-gray-100 dark:border-slate-800'>
                    <div className='flex items-center gap-1.5 text-xs text-gray-500 dark:text-slate-400 mb-2'>
                        ...
                        <a 
                            ...
                            className="truncate hover:text-blue-600 dark:hover:text-blue-400 hover:underline cursor-pointer font-medium"
                        >
                            {loc.address}
                        </a>
                    </div>
